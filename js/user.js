...
function clickHandler(){
    ...
    console.log(loginContainer.hidden, localStorage.getItem(LS_KEY.NAME))
    console.log(!loginContainer.hidden && localStorage.getItem(LS_KEY.NAME) !== 'rockstar');
    if(!loginContainer.hidden && localStorage.getItem(LS_KEY.NAME) !== "") {
...
function submitHandler(event){
    ...
    localStorage.setItem(LS_KEY.NAME, this.children[0].value);
    document.location.href = "/";
}
function main(){
